...
describe('Invoice e2e test', () => {
  ...
  const invoiceSample = {
    date: '2023-01-20T15:29:17.470Z',
    status: 'PAID',
    paymentMethod: 'PAYPAL',
    paymentDate: '2023-01-20T14:25:48.622Z',
    paymentAmount: 4928,
  };
  ...
  describe('new Invoice page', () => {
    ...
    it('should create an instance of Invoice', () => {
      cy.get(`[data-cy="date"]`).type('2023-01-20T03:59').blur().should('have.value', '2023-01-20T03:59');
      ...
      cy.get(`[data-cy="paymentDate"]`).type('2023-01-20T10:27').blur().should('have.value', '2023-01-20T10:27');

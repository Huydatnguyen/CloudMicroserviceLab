...
describe('Notification e2e test', () => {
  ...
  const notificationSample = {
    date: '2023-01-20T16:06:46.457Z',
    sentDate: '2023-01-20T16:33:49.531Z',
    format: 'EMAIL',
    userId: 20600,
    productId: 75536,
  };
  ...
  describe('new Notification page', () => {
    ...
    it('should create an instance of Notification', () => {
      cy.get(`[data-cy="date"]`).type('2023-01-19T23:35').blur().should('have.value', '2023-01-19T23:35');

      cy.get(`[data-cy="details"]`).type('firewall multimedia').should('have.value', 'firewall multimedia');

      cy.get(`[data-cy="sentDate"]`).type('2023-01-20T09:15').blur().should('have.value', '2023-01-20T09:15');

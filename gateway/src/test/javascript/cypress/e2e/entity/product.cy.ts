...
describe('Product e2e test', () => {
  ...
  describe('new Product page', () => {
    ...
    it('should create an instance of Product', () => {
      ...
      cy.get(`[data-cy="upc"]`).type('Massachusetts Personal').should('have.value', 'Massachusetts Personal');

      cy.get(`[data-cy="name"]`).type('transition Division monitor').should('have.value', 'transition Division monitor');
